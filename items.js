...
var rootRef1 = firebase.database().ref().child(queries);
 ...
 var rootRef12 = firebase.database().ref().child(queries).child(id);
var name;
var price;
var itemid
...
function addToCart(itemid)
{
    ...
    if (user!=null) {
		...
		var rootRef13 = firebase.database().ref().child(queries).child(id).child(itemid);
